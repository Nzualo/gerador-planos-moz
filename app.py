...
def check_password():
    ...
    with col2:
        ...
        # Mensagem corrigida (sem SNE no final)
        mensagem = "Olá Técnico Nzualo, sou professor do distrito e gostaria de solicitar acesso (Usuário e Senha) ao Gerador de Planos."
...
st.title("🇲🇿 SNE - Sistema de Gestão de Planos")
